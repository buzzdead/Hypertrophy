  ...
  return (
    <SafeAreaView>
      <View style={{height: '100%', justifyContent: 'center', gap: 50}}>
        <Text style={{paddingTop: 50, textAlign: 'center', fontFamily: 'Roboto-Medium', fontSize: 30, color: colors.categories.Back}}>Progress for week: {weekNumber}</Text>
        <Chart maxExercises={state.maxExercises} chartData={state.chartData} days={state.days} mode='Categories' isLandScape={false} />
      </View>
    </SafeAreaView>
  );
};
