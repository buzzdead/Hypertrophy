    ...
    <SafeAreaView>
      ...
      <CustomButton
        ...
        <CustomButton
          ...
          title={"<"}
        />
        <Text style={{fontFamily: "Roboto-Bold", color: colors.summerDarkest, fontSize: 16, paddingTop: 3}}>{`${typeof textDisplay === "number" ? "Week" : ""} ${textDisplay}`}</Text>
        <CustomButton
...
const styles = (a: boolean | Boolean) => StyleSheet.create({
  pagination: {
    flexDirection: "row",
    gap: 3,
    alignItems: "center",
